...
public class UsuarioControllerTest {
	...
	public void naoDeveDuplicarUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L, "Maria Silva", "maria_silva@email.com.br", "13465278", "-"));
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(
				new Usuario(0L, "Maria Silva", "maria_silva@email.com.br", "13465278", "-"));
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST,
				corpoRequisicao, Usuario.class);
	...
	public void deveMostrarTodosUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Paulo Silvera", "paulo_silvera@email.com.br", "13465278", "-"));
